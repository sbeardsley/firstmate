...
| `fm-install-pi-loop.sh`  | Copy the tracked crewmate loop-detector extension (`pi-extensions/firstmate-pi-loop.ts`) to the user-global `~/.pi/agent/extensions/` directory |
