...
unmapped quota-balanced candidate is advisory^{"rules":[{"when":"unknown upstream","use":[{"harness":"pi","model":"openai-codex/gpt-5.6-sol","effort":"max"},{"harness":"codex","model":"gpt-5.5","effort":"high"}],"select":"quota-balanced"}]}^grep^CREW_DISPATCH: quota-balanced candidate pi/openai-codex/gpt-5.6-sol has no known quota vendor; selector excludes it from quota comparison
unknown explicit quota vendor is advisory^{"rules":[{"when":"unknown explicit upstream","use":[{"harness":"pi","model":"glm-5.2","effort":"high","vendor":"pi"}],"select":"quota-balanced"}]}^grep^CREW_DISPATCH: quota-balanced candidate pi/glm-5.2 declares unknown quota vendor "pi"; selector excludes it from quota comparison
